...
/**
 * Class to store a limited amount of history items (not more
 * than [CAPACITY]) and return them if needed.
 */
object HistoryStorage {
    /**
     * Maximum amount of items that the [HistoryStorage]
     * can store at a time.
     */
    ...
    /**
     * Adds the name of this command to the storage, removing
     * an element at the beginning if the size of the storage
     * exceeds [CAPACITY].
